...
const Signin = () => {
    ...
    return ( <
        section className = "signin" > { showLoading() } { showError() } <
        ...
        h1 >
        <
        GoogleLogin clientId = "994355747421-3d51nir2he9edu09lapanvif6rdfb003.apps.googleusercontent.com"
        buttonText = ""
        render = {
            renderProps => ( <
        ...
        h1 >
        <
        FacebookLogin appId = "540869129968601"
